...
<template>
    <section
        class="flex flex-col gap-[30px] items-center justify-center h-full lg:flex-row bg-gray-50 w-full max-w-[1336px] lg:min-h-[600px] px-[15px] my-[30px] lg:px-[30px] dark:bg-gray-900 lg:rounded-xl">
        <!-- Left section - image -->
