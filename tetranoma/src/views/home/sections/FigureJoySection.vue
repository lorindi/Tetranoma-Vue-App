...
<template>
    <section
        class="flex flex-col gap-[30px] items-center justify-center h-full lg:flex-row bg-gray-50 w-full max-w-[1336px] lg:min-h-[600px] px-[15px] my-[30px] lg:px-[30px] ">
        <!-- Left section - image -->
        ...
        <div class="flex flex-col flex-1 lg:text-left lg:gap-[15px] lg:text-xl lg:px-[15px]">
            ...
            <p class="hidden text-gray-800 lg:block">Each 3D figure is unique, adding a personal touch to your décor.</p>
            <p class="hidden text-gray-800 lg:block">They inspire creativity and spark conversations, making your home feel more lively.</p>
            <p class="hidden text-gray-800 lg:block">Perfect for any space - from your living room to your office, 3D figures complement any home
                decor.</p>
